---
description: "Public summary of the Aevum maintenance methodology — investigation gate, inside-out, known unknowns, and automation bias awareness."
---

# Maintenance Playbook — Public Summary
...
The three principle tiers in
[`principles.yaml`](https://github.com/aevum-labs/aevum/blob/main/principles.yaml)
explain why:
...
[`KNOWN_UNKNOWNS.md`](https://github.com/aevum-labs/aevum/blob/main/KNOWN_UNKNOWNS.md).
What is new and unknown? What was previously unknown and is now known? Gaps
are not failures — undocumented gaps are.
...
See
[`CONTRIBUTING.md`](https://github.com/aevum-labs/aevum/blob/main/CONTRIBUTING.md)
...
- **L-scope changes** (barriers.py, sigchain format, new packages, public API
  ...
  documented in
  [`GOVERNANCE.md`](https://github.com/aevum-labs/aevum/blob/main/GOVERNANCE.md).
