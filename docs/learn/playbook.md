...
[`KNOWN_LIMITATIONS.md`](https://github.com/aevum-labs/aevum/blob/main/KNOWN_LIMITATIONS.md).
What gap is new? What was previously a gap and is now closed? Gaps are not
failures — undocumented gaps are.
