...
With `aevum-core[pqc]` installed (liboqs available): generates Ed25519 + ML-DSA-65 hybrid
keys (the default, per ADR-012). **Without the PQC backend: `aevum init` fails closed — it
