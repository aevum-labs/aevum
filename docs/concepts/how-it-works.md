...
This closes the TOCTOU window: the audit trail now proves not
just what the agent decided, but that the state the decision was
based on was still current when the commit fired.
